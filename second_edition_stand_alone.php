...
<head>
	...
	<script type="text/javascript" src="/dungeonquest/dungeonquest_second_edition_stand_alone.js"></script>
	...
	<script type="text/javascript">
		...
		function search_chamber(){
			...
			if (curr_hero_chamber.searchable == '1') {
				if (parseInt(curr_hero_chamber.searched) < 2) {
		...
		function search_dragon_chamber(){
			...
			if ((hero_map[hero1.x*100 + hero1.y].type == 'treasure') && 
				!dragon_deck.empty() && 
				!treasure_deck.empty()) {
...
<div class="introduction_screen" style="display: none; padding: 10px;">
		...
		<div style="text-align: justify; max-width: 800px; margin: auto; padding: 0 20px 0 20px;">
			<p style="margin-bottom: 10px;">A thousand years have passed since the evil wizard T'Siraman fell, 
    ...
    <div class="modal-content">
      <div class="modal-body" style="vertical-align: top; margin: 0 auto;">
		<div>
			...
			<div style="margin: 10px 0px 10px 0; font-size: 16px; font-weight: bold;">Note</div>
			<table class="table table-condensed">
				<tr>
					<td style="text-align: justify;">Special thanks to Friendly Bombs for giving me the inspiration to re-create this amazing board game.</td>
				</tr>
			</table>
		</div>
      </div>
