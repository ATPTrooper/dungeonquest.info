	...
	<script type="text/javascript">
			...
			$('#trap_modal').on('hidden.bs.modal', function () {
				...
				if (encounter_queue[0] != undefined) {
					...
					for (var i = 0; i < encounter_queue.length; i++) {
						write_to_console("encounter " + encounter_queue[0].type + " " + encounter_queue[0].title);
					}
					...
					if (encounter_queue[0].resolved == '1' && encounter_queue[0].success == '1') {
						...
						// setup next encounter, or move hero
		...
		function resolve_obstacle(p_direction, p_obstacle, p_adjacent_obstacle) {
			...
			// passage and portcullis
				...
				var new_encounter = new Encounter('portcullis', 'You see a Portcullis', '#D1001C', 'white', 'Do you want to raise the Portcullis?', p_direction);
			...
			// bridge and door
				...
				if (moving_backwards(p_direction)) { return true; }
			...
			// bridge and portcullis
				...
				var new_encounter = new Encounter('bridge', 'You see a Plank', '#D1001C', 'white', 'Do you want to raise the Plank?', p_direction);
				encounter_queue.push(new_encounter);
				
				new_encounter = new Encounter('portcullis', 'You see a Portcullis', '#D1001C', 'white', 'Do you want to raise the Portcullis?', p_direction);
				encounter_queue.push(new_encounter);
			...
			// pit and portcullis
				...
				var new_encounter = new Encounter('pit', 'Pit', '#D1001C', 'white', 'Do you want to jump over the Pit?', p_direction);
				encounter_queue.push(new_encounter);
			...
			// rubble and portcullis
				...
				var new_encounter = new Encounter('rubble', 'Rubble', '#D1001C', 'white', 'Do you want to move through the Rubble?', p_direction);
				encounter_queue.push(new_encounter);
			...
			// rubble and ANYTHING
				...
				var new_encounter = new Encounter('rubble', 'Cave-In Chamber', '#D1001C', 'white', 'Do you want to move through the Rubble?', p_direction);
				encounter_queue.push(new_encounter);
			...
			// spiderweb and portcullis
				...
				var new_encounter = new Encounter('bridge', 'Spider Web', '#D1001C', 'white', 'Do you want to move through the Spider Web?', p_direction);
				encounter_queue.push(new_encounter);
			...
			// spiderweb and ANYTHING
				...
				var new_encounter = new Encounter('spiderweb', 'Spider Web', '#D1001C', 'white', 'Do you want to move through the Spider Web?', p_direction);
				encounter_queue.push(new_encounter);
		...
		//9 darkness
			...
			switch(trap_triggered_type) {
				...
				case "portcullis":
					...
					if (total <= hero1.strength) {
						write_to_trap_console('['+total+'] You raised the Portcullis!!');
						...
						$('.dice_total').css("background-color", "#D1001C");
						$('.dice_total').css("color", "white");
							write_to_trap_console('['+total+'] You failed to raise the Portcullis!!');
				...
				case "pit":
					...
					if (total <= hero1.strength) {
						write_to_trap_console('['+total+'] You jumped over the Pit!!');
						...
						$('.dice_total').css("background-color", "#D1001C");
						$('.dice_total').css("color", "white");
							write_to_trap_console('['+total+'] You fell into the Pit!!');
							write_to_console('['+total+'] You fell into the Pit!!');
							$('.trap_text').html("You fell into the Pit!!");
					}
				...
				case "rubble":
					...
					if (total <= hero1.strength) {
						write_to_trap_console('['+total+'] You moved through the Rubble!!');
						write_to_console('['+total+'] You moved through the Rubble!!');
						$('.dice_total').css("background-color", "#00FF00");
						$('.dice_total').css("color", "white");
						$('.trap_text').html("You crossed the plank");
						force_hero_movement(current_direction);
						...
						$('.dice_total').css("background-color", "#D1001C");
						$('.dice_total').css("color", "white");
							write_to_trap_console('['+total+'] You failed to find passage through the Rubble!!');
	...
	<div class="div-desktop">
		...
		<div class="dungeon_dashboard">
			...
			<div class="movement_dashboard" id="movement_dashboard">
				<div style="display: inline-block;"><input class="btn btn-primary" type="button" name="encounter_button" value="Encounter" onclick="print_encounter();" /></div>
