...
<head>
	...
	<script type="text/javascript">
		...
		function add_encounter(type, p_direction) {
			...
			switch (type) {
				...
				case "goblin":
					...
					write_to_debugger(monster.name + " " + monster.image_url);
					break;
				case "troll":
					play_audio("monster_wounded");
			...
			switch(current_encounter.type) {
				...
				case "ambushtroll":
					...
					if (p_button == 'ambushed') {
						...
						if (hero_dead()) {
							write_to_console('['+total+'] You are killed by the '+monster_name+'!');
							$('.encounter_text').html("You are killed by the "+monster.name+"!");
							game_over = true;
						}
						
						encounter_queue[0].ambushed = '0';
		...
		function battle_action(p_action) {
			...
			if (escape_closed()) {
				$('.encounter_escape_button').prop("disabled", true);
			}
				...
				case "wait":
					...
					if (parseInt(monster.health) == 0) {
						if (monster.type == "blackknight") {
							...
							$('.encounter_text').html("You evaded " + monster_name);
						} else {
							write_to_console("Battle: " + monster.name + " flees");
							$('.encounter_text').html(monster.name + " flees");
						}
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<button type="button" id="encounter_ambushed_button" class="encounter_ambushed_button btn btn-primary" value="Combat" onclick="roll_encounter_dice('ambushed')">Ambushed</button>
