	...
	<script type="text/javascript">
				...
				switch (String(p_direction)) {
					case '1':
						...
						if (p_curr_hero_chamber.top == '5') {
							add_encounter("portcullis", 0, p_direction);
							encounter_counter++;
						}
						if (next_bottom == '3') {
							add_encounter('door', randomDoor.value, p_direction);
		...
		function resolve_obstacle(p_direction, p_obstacle, p_next_obstacle) {
			...
			// bridge and door
				...
				add_encounter("bridge", 0, p_direction);
				add_encounter("door", randomDoor.value, p_direction);
				force_trap_modal();
			...
			// pit and door
				...
				add_encounter("pit", 0, p_direction);
				add_encounter("door", randomDoor.value, p_direction);
				force_trap_modal();
			...
			// rubble and door
				...
				add_encounter("rubble", 0, p_direction);
				add_encounter("door", randomDoor.value, p_direction);
				force_trap_modal();
			...
			// spiderweb and door
				...
				add_encounter("spiderweb", randomDoor.value, p_direction);
				add_encounter("door", randomDoor.value, p_direction);
				force_trap_modal();
			...
			// darkness and ANYTHING (includes handling door and portcullis)
			} else if (p_obstacle == '9') {
				
				add_encounter("darkness", randomDoor.value, p_direction);
				force_trap_modal();
					...
					if (next_hero_chamber != undefined) {
						...
						if (next_hero_chamber.bottom == '2') {
							...
							if (next_hero_chamber.bottom == '3') {
								...
								add_encounter("portcullis", randomDoor.value, p_direction);
							}
						}
					}
				} else {
