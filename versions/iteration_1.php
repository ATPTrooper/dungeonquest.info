...
<head>
	...
	<script type="text/javascript">
		...
		var ChamberJSON_string = '[{"1": {"top": "1", "right": "1", "type": "1", "bottom": "1", "left": "1", "image_url": ""}}' +
								',{"2": {"top": "1", "right": "2", "bottom": "1", "left": "1", "type": "1", "image_url": ""}}' +
								',{"3": {"top": "1", "right": "1", "bottom": "1", "left": "2", "type": "1", "image_url": ""}}' +
								',{"4": {"top": "2", "right": "1", "bottom": "1", "left": "1", "type": "1", "image_url": ""}}' +
								',{"5": {"top": "1", "right": "2", "bottom": "1", "left": "2", "type": "1", "image_url": ""}}' +
								',{"6": {"top": "2", "right": "2", "bottom": "1", "left": "1", "type": "1", "image_url": ""}}' +
								',{"7": {"top": "2", "right": "1", "bottom": "1", "left": "2", "type": "1", "image_url": ""}}' +
								
								',{"11": {"top": "1", "right": "1", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								',{"12": {"top": "1", "right": "2", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								',{"13": {"top": "1", "right": "1", "bottom": "1", "left": "2", "type": "2", "image_url": ""}}' +
								',{"14": {"top": "2", "right": "1", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								',{"15": {"top": "1", "right": "2", "bottom": "1", "left": "2", "type": "2", "image_url": ""}}' +
								',{"16": {"top": "2", "right": "2", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								',{"17": {"top": "2", "right": "1", "bottom": "1", "left": "2", "type": "2", "image_url": ""}}' +
								
								',{"21": {"top": "3", "right": "1", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								',{"22": {"top": "3", "right": "2", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								',{"23": {"top": "3", "right": "1", "bottom": "1", "left": "2", "type": "2", "image_url": ""}}' +
								',{"24": {"top": "2", "right": "1", "bottom": "1", "left": "3", "type": "2", "image_url": ""}}' +
								',{"25": {"top": "3", "right": "2", "bottom": "1", "left": "2", "type": "2", "image_url": ""}}' +
								',{"26": {"top": "2", "right": "2", "bottom": "1", "left": "3", "type": "2", "image_url": ""}}' +
								',{"27": {"top": "2", "right": "3", "bottom": "1", "left": "2", "type": "2", "image_url": ""}}' +
								
								',{"31": {"top": "1", "right": "1", "bottom": "1", "left": "3", "type": "2", "image_url": ""}}' +
								',{"32": {"top": "1", "right": "2", "bottom": "1", "left": "3", "type": "2", "image_url": ""}}' +
								',{"33": {"top": "1", "right": "3", "bottom": "1", "left": "2", "type": "2", "image_url": ""}}' +
								',{"34": {"top": "2", "right": "3", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								',{"45": {"top": "1", "right": "3", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								
								',{"41": {"top": "3", "right": "1", "bottom": "1", "left": "3", "type": "2", "image_url": ""}}' +
								',{"42": {"top": "3", "right": "2", "bottom": "1", "left": "3", "type": "2", "image_url": ""}}' +
								',{"43": {"top": "3", "right": "3", "bottom": "1", "left": "2", "type": "2", "image_url": ""}}' +
								',{"44": {"top": "3", "right": "3", "bottom": "1", "left": "1", "type": "2", "image_url": ""}}' +
								',{"45": {"top": "1", "right": "3", "bottom": "1", "left": "3", "type": "2", "image_url": ""}}]';
		...
		function reset_board(){
			...
			$('#dungeon_board_cell_7_5').css('background-image','url("/dungeonquest/treasure_room_top.jpg")');
			$('#dungeon_board_cell_7_6').css('background-image','url("/dungeonquest/treasure_room_bottom.jpg")');

		}
		
		function set_starting_tiles(){
			
			hero_map[101] = new Chamber(0,'1','1','2','2','/dungeonquest/corner.jpg');
			hero_map[1301] = new Chamber(0,'1','2','2','1','/dungeonquest/corner.jpg');
			hero_map[110] = new Chamber(0,'2','1','1','2','/dungeonquest/corner.jpg');
			hero_map[1310] = new Chamber(0,'2','2','1','1','/dungeonquest/corner.jpg');
		...
		function valid_movement(p_Direction) {
			...
			if (next_hero_chamber == undefined) {
				...
				switch (p_Direction) {
					case '1':
						if (hero_chamber.top == 1 && next_hero_chamber.bottom == 1) { return true; }
						break;
					case '2':
						if (hero_chamber.right == 1 && next_hero_chamber.left == 1) { return true; }
						break;
					case '3':
						if (hero_chamber.bottom == 1 && next_hero_chamber.top == 1) { return true; }
						break;
					case '4':
						if (hero_chamber.left == 1 && next_hero_chamber.right == 1) { return true; }
						break;
					default:
						return false;
				}
		...
		class Chamber {
			constructor(id, top, right, bottom, left, orientation) {
				this.id = id;
				this.top = top;
				this.bottom = bottom;
				this.left = left;
		...
		function draw_chamber(p_Direction) {
			...
			if (!is_exit_chamber(hero1) && !is_treasure_chamber(hero1)) {
				...
				if (hero_map[eval(hero1.x*100 + hero1.y)] == undefined) { 
					...
					hero_map[eval(hero1.x*100 + hero1.y)] = new Chamber(randomNumber, new_top, new_right, new_bottom, new_left, p_Direction, randomChamber.image_url);
					$('#dungeon_board_cell_'+(hero1.x)+'_'+(hero1.y)).css("background-image", "url('/dungeonquest/"+randomNumber+".jpg')");
	...
	<style type="text/css">
		...
		.character_dashboard { display: block; text-align: center; vertical-align: top; margin: 20px;}
		.hero_sheet { display: inline-block; vertical-align: top; width: 200px; margin-right: 20px; }
		.loot_sheet { display: inline-block; vertical-align: top; width: 200px; margin-right: 20px; }
		.timer { display: inline-block; }
		.movement_controls { display: inline-block; margin: 0 auto; text-align: center; }
...
<div class="character_dashboard" id="character_dashboard">
	...
	<div class="loot_sheet" id="loot_sheet">
		<table class="table table-condensed table-bordered">
			<tr><td class="col-sm-8"><b>Timer</b></td><td class="col-sm-4"><span id="timer"></span></td></tr>
	...
	<div class="movement_controls">
		<div class="movement_controls">
			<input class="btn btn-primary" type="button" name="up_button" id="up_button" value="Up" onclick="move_hero('up');" /><br/>
			<div style="display: inline-block;">
			<input class="btn btn-primary" type="button" name="left_button" id="left_button" value="Left" onclick="move_hero('left');" />
			<input class="btn btn-primary" type="button" name="down_button" id="down_button" value="Down" onclick="move_hero('down');" />
			<input class="btn btn-primary" type="button" name="right_button" id="right_button" value="Right" onclick="move_hero('right');" />
			</div>
		</div>
	</div>
