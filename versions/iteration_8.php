	...
	<script type="text/javascript">
		...
		function stumble_to_the_right(p_dice_roll, p_Direction) {
			...
			if (String(curr_hero_chamber.orientation) == '0') {
				next_hero_chamber = hero_map[(hero1.x+1)*100 + hero1.y];
				toggle_alert_modal('darkness', 'Darkness', '', 'In the darkness, you exit to the east');
				new_direction = '2';
			} else if (String(curr_hero_chamber.orientation) == '90') {
				next_hero_chamber = hero_map[(hero1.x)*100 + hero1.y-1];
				toggle_alert_modal('darkness', 'Darkness', '', 'In the darkness, you exit to the south');
				new_direction = '3';
			} else if (String(curr_hero_chamber.orientation) == '180') {
				next_hero_chamber = hero_map[(hero1.x-1)*100 + hero1.y];
				toggle_alert_modal('darkness', 'Darkness', '', 'In the darkness, you exit to the west');
				new_direction = '4';
			} else if (String(curr_hero_chamber.orientation) == '270') {
				next_hero_chamber = hero_map[(hero1.x)*100 + hero1.y+1];
				toggle_alert_modal('darkness', 'Darkness', '', 'In the darkness, you exit to the north');
				new_direction = '1';
			}
		...
		function search_room(){
			...
			if (curr_hero_chamber.type != 0 && 
				...
				if (parseInt(curr_hero_chamber.searched) < 999) {
					if (confirm("Do you want to search the room?")) {
						...
						switch (randomDraw.type) {
							...
							case "centipede":
								...
								break;
							case "ferrox":
								write_to_console('A Ferrox attacks you!!');
								break;
							case "trap":
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="vertical-align: top; text-align: center;">
			...
			<div id="alert_modal_text" style="margin: 20px; font-size: 40px;"></div>
      </div>
      <div class="modal-footer">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="vertical-align: top; text-align: center;">
			...
			<div id="ending_modal_text" style="margin: 20px; font-size: 40px;"></div>
      </div>
      <div class="modal-footer">
