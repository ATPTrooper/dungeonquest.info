	...
	<script type="text/javascript">
			...
			$('#encounter_modal').on('hidden.bs.modal', function () {
				...
				if (encounter_queue[0] != undefined) {
					...
					if (
						...
						encounter_queue[0].type == "ambushorc" ||
		...
		function encounter_chamber() {
			...
			switch (randomDraw.type) {
				...
				case "ambushgoblin":
					...
					add_encounter('ambushgoblin', '0')
					force_encounter_modal();
					break;
				case "ambushorc":
					play_audio("monster_wounded");
					write_to_console('Encounter: Ambush Orc');
					add_encounter('ambushorc', '0')
					force_encounter_modal();
					break;
				case "ambushtroll":
					play_audio("monster_wounded");
					write_to_console('Encounter: Ambush Troll');
					add_encounter('ambushtroll', '0')
					force_encounter_modal();
					break;
			}
		}
		...
		function add_encounter(type, p_direction) {
			...
			switch (type) {
				...
				case "ambushorc":
					play_audio("monster_wounded");
					new_encounter = new Encounter('ambushorc', 'Orc', '#D1001C', 'white', 'Ambush: Orc! <br/> Damage: D12 - Luck', p_direction);
					new_encounter.show_combat_buttons = '1';
					new_encounter.before_combat = '1';
					new_encounter.ambushed = '1';
					new_encounter.can_wait = '0';
		...
		function battle_action(p_action) {
			...
			switch(p_action) {
				...
				case "ambushed":
					...
					write_to_debugger("set can_shoot_first_arrow: " + current_encounter.can_shoot_first_arrow);
					write_to_debugger("set can_shoot_second_arrow: " + current_encounter.can_shoot_second_arrow);
		...
		function setup_combat_buttons() {
			...
			if (parseInt(hero1.arrows) > 0 && current_encounter.can_shoot_first_arrow == '1') { $('.encounter_shoot_first_arrow_button').prop("disabled", false); }
			if (parseInt(hero1.arrows) > 0 && current_encounter.can_shoot_second_arrow == '1') { $('.encounter_shoot_second_arrow_button').prop("disabled", false); }
			...
			if (hero1.have_range == '0') {
				$('.encounter_shoot_first_arrow_button').hide();
				$('.encounter_shoot_second_arrow_button').hide();
			}
			
			if (current_encounter.can_shoot_first_arrow == '0') {
				$('.encounter_shoot_first_arrow_button').hide();
			}
