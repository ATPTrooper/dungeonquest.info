		...
		function cross_bridge(p_Direction) {
			...
			if (moving_backwards(p_Direction)) {
				return true;
					...
					$('.trap_dice_placeholder').attr("onclick", "").unbind("click");
					$('#trap_button').attr("onclick", "").unbind("click");
					$(".trap_dice_placeholder").on('click', function(){ roll_trap_dice(); });
					$("#trap_button").on('click', function(){ roll_trap_dice(); });
...
<div class="modal" id="trap_modal" tabindex="-1" role="dialog" aria-labelledby="trap_modal_label" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="margin: 0px;">
        <h4 class="modal-title" id="trap_modal_title" class="trap_modal_title">You Triggered a Trap!</h4>
      </div>
      <div class="modal-body" style="vertical-align: top; margin: 0 auto;">
			...
			<div class="trap_character_sheet" style="display: inline-block; width: 250px; vertical-align: top;">
			</div>
			...
			<!-- Console and Loot Sheet -->
			<div class="trap_console_sheets" style="margin: 0 auto; width: 270px;">
				<div class="trap_console_sheet table-bordered" style="">
					<div class="trap_console" style="font-size: 12px; text-align: left;"></div>
				</div>
			</div>
			<div class="trap_loot_sheets" style="margin: 0 auto; width: 270px;">
